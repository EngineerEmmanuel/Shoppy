...
const Footer = () => {
    return ( 
        <section className="bg-black mt-20">
            <h1>footer</h1>
            {/* footer container */}
            <div className="flex flex-col gap-6 text-white pr-2 pl-2 md:grid grid-cols-3 lg:grid grid-cols-5">
                {/* logo con */}
                <div>
                ...
                {/* Entize container */}
                <div>
                    <h2 className="pb-3 font-bold">Entize</h2>
                ...
                {/* Buy container */}
                <div>
                    <h2 className="pb-3 font-bold">Buy</h2>
                    <ul className="cursor-pointer">
                        <li>Bill & Top Up</li>
                        <li>Entzie COD</li>
                        <li>Affiliate</li>
                ...
                {/* sell container */}
                <div>
                    <h2 className="pb-3 font-bold">Sell</h2>
                    <ul className="cursor-pointer">
                ...
                {/* Guide and Help */}
                <div>
                    <h2 className="pb-3 font-bold">Guide and Help</h2>
                    <ul className="cursor-pointer">
                        <li>Entize Care</li>
